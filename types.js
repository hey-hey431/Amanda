 ...
 * @property {{storage: import("discord.js").Collection<import("discord.js").Snowflake, import("./modules/compiledtypings/queue.js")>, songsPlayed: Number, events: import("events").EventEmitter, addQueue: (queue: import("./modules/compiledtypings/queue.js")) => void, removeQueue: (queue: import("./modules/compiledtypings/queue.js")) => void}} queueManager
